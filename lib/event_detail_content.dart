...
import 'package:local_events/guest.dart';
      ...
      child: Column(
        children: <Widget>[
          ...
          child: FittedBox(
            child: Row(
              children: <Widget>[
                Text("-",style:eventLocationTextStyle.copyWith(color: Colors.white,
                    fontWeight: FontWeight.w700),
                ),
                Icon(Icons.location_on, color: Colors.white,size: 30,),
                SizedBox(width: 5,),
                Text(event.location,
                  style: eventLocationTextStyle.copyWith(color: Colors.white,
                  fontWeight: FontWeight.w700),),
              ],
            ),
          ),
            ...
            Text("GUESTS", style: TextStyle(color: Colors.white)),
